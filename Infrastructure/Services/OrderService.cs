...
{
    private readonly IBasketRepository _basketReop;
    private readonly IUnitOfWork _unitOfWork;

    public OrderService(IBasketRepository basketReop, IUnitOfWork unitOfWork)
    {
        _basketReop = basketReop;
    ...
    public async Task<Order> CreateOrderAsync(string buyerEmail, int deliveryMethodId, string basketId, Address shippingAddress)
    {
        ...
        var basket = await _basketReop.GetBasketAsync(basketId);
        ...
        await _basketReop.DeleteBasketAsync(basketId);
