...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51OhdZTI80R3Gek5UNjG45JhGa0I47QSYoWmV0XhouB8o9dF0KWW2bPMKGvbzzi4Ozbdr8mFYUvhYi8aokWqWSivP001hqk57xn')
      .then(stripe => {
        this.stripe = stripe;
  ...
  confirmPaymentWithStripe(basket: Basket | null) {
    if (!basket) throw Error('Basket is null');
